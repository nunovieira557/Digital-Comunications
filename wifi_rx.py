...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/nuno/Documents/CDIG/Wifi_Project_Baseband_recordings/Sample3_20MHz_Channel100.bin', False, 0, 0)
        ...
        self.msg_connect((self.ieee802_11_frame_equalizer_0, 'symbols'), (self.pdu_pdu_to_tagged_stream_1, 'pdus'))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_1, 0), (self.qtgui_const_sink_x_1, 0))
