...
class Project_receiver_802a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Project_receiver_802a")
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('usb:3.4.5' if 'usb:3.4.5' else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(ieee802_11.LS, freq, 20000000, False, False)
        self.ieee802_11_decode_mac_0 = ieee802_11.decode_mac(False, False)
        self.foo_wireshark_connector_1 = foo.wireshark_connector(127, True)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/nuno/Documents/CDIG/Coisas_da_pasta_Digital_Communications/test.pcapng', False)
        ...
        self.msg_connect((self.ieee802_11_parse_mac_0, 'out'), (self.foo_wireshark_connector_1, 'in'))
...
def main(top_block_cls=Project_receiver_802a, options=None):
